...
- `commuted_calligraphy/story_brief/data/partner_distributions.json` (date-aware weighted `sexual_partner` pools; `[]` indicates celibacy, while `null`/missing indicates absent data)
